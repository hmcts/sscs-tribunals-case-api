...
public class UcDecisionNoticeFunctionalTestPrint extends BaseFunctionTest {
    ...
    public void scenario1_refused_non_support_group_less_than_15pts_sch6_sch8Para4NotApplies_shouldGeneratePdfWithExpectedText() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            File file = new File("/Users/christopherdavidson/Documents/Decision/UC Refused all.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario2_refused_isSupportGroup_noSch7_Sch8Para4NotApplies_shouldGeneratePdfWithExpectedText() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            File file = new File("/Users/christopherdavidson/Documents/Decision/UC Refused Support no sch 7 no sch 9 para 4.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario3_allowed_isSupportGroup_noSch7_Sch9Para4Applies() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, containsString("6. The tribunal applied Schedule 9, paragraph 4 because there would be a substantial risk to the mental or physical health of any person if the appellant were found not to have limited capability for work and for work-related activity."));
            ...
            File file = new File("/Users/christopherdavidson/Documents/Decision/UC Allowed Support no sch 7 yes sch 9 para 4.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario4_allowed_isSupportGroup_selectionMadeForSch7() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, not(containsString("11.")));
            File file = new File("/Users/christopherdavidson/Documents/Decision/UC Allowed Support sched 7.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario5_allowed_notSupportGroup_moreThan15Points_noSch7_NoSch9Para4() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, not(containsString("10.")));
            File file = new File("/Users/christopherdavidson/Documents/Decision/UC Allowed Sched 6 only.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario12_allowed_notSupportGroup_moreThan15Points_noSch7_Sch9Para4() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, not(containsString("11.")));
            File file = new File("/Users/christopherdavidson/Documents/Decision/UC Allowed Sched 6 and sch 9 para 4.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario8_allowed_notSupportGroup_LessThan15PointsSch6_Sch8Para4Applies_Sch9Para4Applies() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, not(containsString("11.")));
            File file = new File("/Users/christopherdavidson/Documents/Decision/UC Allowed sch 8 para 4 and sch 9 para 4.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario10_refused_nonLcwa() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            File file = new File("/Users/christopherdavidson/Documents/Decision/UC Non LWCA Refused all.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario11_allowed_nonLcwaAppeal() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, containsString("7. This has been a remote hearing in the form of a telephone hearing. Joe Bloggs attended and the Tribunal considered the appeal bundle to page B7. A Presenting Officer attended on behalf of the Respondent."));
            assertThat(pdfTextWithoutNewLines, not(containsString("8.")));
            File file = new File("/Users/christopherdavidson/Documents/Decision/UC Non LWCA Allowed.pdf");
            file.createNewFile();
            document.save(file);
        }
    }

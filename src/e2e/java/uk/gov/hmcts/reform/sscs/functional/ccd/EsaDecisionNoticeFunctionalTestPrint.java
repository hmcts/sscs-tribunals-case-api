...
public class EsaDecisionNoticeFunctionalTestPrint extends BaseFunctionTest {
    ...
    public void scenario1_refused_non_support_group_less_than_15pts_sch2_reg29NotApplies_shouldGeneratePdfWithExpectedText() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            File file = new File("/Users/christopherdavidson/Documents/Decision/ESA Refused all.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario2_refused_isSupportGroup_noSch3_Reg29NotApplies_shouldGeneratePdfWithExpectedText() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            File file = new File("/Users/christopherdavidson/Documents/Decision/ESA Refused Support no sch 3 no reg 35 .pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario3_allowed_isSupportGroup_noSch3_Reg35Applies() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            File file = new File("/Users/christopherdavidson/Documents/Decision/ESA Allowed Support no sch 3 yes reg 35.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario4_allowed_isSupportGroup_selectionMadeForSch3() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, not(containsString("11.")));
            File file = new File("/Users/christopherdavidson/Documents/Decision/ESA Allowed Support sched 3.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario5_allowed_notSupportGroup_moreThan15Points_noSch3_NoReg35() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, not(containsString("10.")));
            File file = new File("/Users/christopherdavidson/Documents/Decision/ESA Allowed Sched 2 only.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario6_allowed_notSupportGroup_moreThan15Points_Sch3Applies() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, not(containsString("11.")));
            File file = new File("/Users/christopherdavidson/Documents/Decision/ESA Allowed Sched 2 & 3.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario7_allowed_notSupportGroup_lessThan15Points_Reg29Applies_noSch3_noReg35() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, containsString("10. Any recommendation given below does not form part of the Tribunal's decision and is not binding on the Secretary of State. The Tribunal makes no recommendation as to when the Department should reassess Joe Bloggs."));
            assertThat(pdfTextWithoutNewLines, not(containsString("11.")));
            File file = new File("/Users/christopherdavidson/Documents/Decision/ESA Allowed reg 29 only.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario8_allowed_notSupportGroup_LessThan15PointsSch2_Reg29Applies_Reg35Applies() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, not(containsString("11.")));
            File file = new File("/Users/christopherdavidson/Documents/Decision/ESA Allowed 29 & 35.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario9_allowed_notSupportGroup_lessThan15Points_Reg29Applies_Sch3Applies() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, containsString("10. Any recommendation given below does not form part of the Tribunal's decision and is not binding on the Secretary of State. The Tribunal makes no recommendation as to when the Department should reassess Joe Bloggs."));
            assertThat(pdfTextWithoutNewLines, not(containsString("11.")));
            File file = new File("/Users/christopherdavidson/Documents/Decision/ESA Allowed 29 & Sched 3.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario10_refused_nonWca() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            File file = new File("/Users/christopherdavidson/Documents/Decision/ESA Non WCA Refused all.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario11_allowed_nonWcaAppeal() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, containsString("7. This has been a remote hearing in the form of a telephone hearing. Joe Bloggs attended and the Tribunal considered the appeal bundle to page B7. A Presenting Officer attended on behalf of the Respondent."));
            assertThat(pdfTextWithoutNewLines, not(containsString("8.")));
            File file = new File("/Users/christopherdavidson/Documents/Decision/ESA Non WCA Allowed.pdf");
            file.createNewFile();
            document.save(file);
        }
    }
    ...
    public void scenario12_allowed_notSupportGroup_moreThan15Points_noSch3_Reg35Applies() throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, containsString("10. Any recommendation given below does not form part of the Tribunal's decision and is not binding on the Secretary of State. The Tribunal makes no recommendation as to when the Department should reassess Joe Bloggs."));
            assertThat(pdfTextWithoutNewLines, not(containsString("11.")));
            File file = new File("/Users/christopherdavidson/Documents/Decision/ESA Allowed Sched 2 and Reg 35.pdf");
            file.createNewFile();
            document.save(file);
        }
    }

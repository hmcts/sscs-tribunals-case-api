...
public class PipDecisionNoticeFunctionalTest extends BaseFunctionTest {
    ...
    public void notConsideredNoAward_shouldGeneratePdfWithExpectedTextForHearingType(String hearingType, boolean appellantAttended, boolean presentingOfficerAttended) throws IOException {
        ...
        String json;
        if (indefinite) {
            json = getJsonCallbackForTestAndReplace("handlers/writefinaldecision/pipScenarioCallbackHearingType.json", Arrays
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines,
                containsString("4. Joe Bloggs does not qualify for an award of the mobility component from 17/12/2020. They score 0 points. This is insufficient to meet the threshold for the test."));
            ...
            if ("video".equals(hearingType)) {
                ...
                if (appellantAttended && presentingOfficerAttended) {
                    assertThat(pdfTextWithoutNewLines, containsString(
                        "8. This has been a remote hearing in the form of a triage hearing. Joe Bloggs attended and the Tribunal considered the appeal bundle to page B7. A Presenting Officer attended on behalf of the Respondent."));
                } else if (appellantAttended && !presentingOfficerAttended) {
                    assertThat(pdfTextWithoutNewLines, containsString(
                        "8. This has been a remote hearing in the form of a triage hearing. Joe Bloggs attended and the Tribunal considered the appeal bundle to page B7. No Presenting Officer attended on behalf of the Respondent."));
                } else if (!appellantAttended && presentingOfficerAttended) {
                    assertThat(pdfTextWithoutNewLines, containsString("8. This has been a remote hearing in the form of a triage hearing. Joe Bloggs did not attend the hearing today. A Presenting Officer attended on behalf of the Respondent."));
                    assertThat(pdfTextWithoutNewLines, containsString(
                        "9. Having considered the appeal bundle to page B7 and the requirements of rules 2 and 31 of The Tribunal Procedure (First-tier Tribunal) (Social Entitlement Chamber) Rules 2008 the Tribunal is satisfied that reasonable steps were taken to notify Joe Bloggs of the hearing and that it is in the interests of justice to proceed today."));
                    additionalParagraph = true;
                } else if (!appellantAttended && !presentingOfficerAttended) {
    ...
    public void standardRateNotConsidered_shouldGeneratePdfWithExpectedText(String comparedToDwpDailyLiving, boolean allowed, boolean setAside, boolean indefinite) throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines,
                containsString("4. Joe Bloggs has limited ability to carry out the activities of daily living set out below. They score 8 points. They satisfy the following descriptors:"));
    ...
    public void standardRateNoAward_shouldGeneratePdfWithExpectedText(String comparedToDwpMobility, String comparedToDwpDailyLiving, boolean allowed, boolean setAside, boolean indefinite)
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines, containsString("8 points"));
            assertThat(pdfTextWithoutNewLines,
                containsString("5. Joe Bloggs does not qualify for an award of the mobility component from 17/12/2020. They score 0 points. This is insufficient to meet the threshold for the test."));
            assertThat(pdfTextWithoutNewLines, containsString("12. Moving around a."));
            assertThat(pdfTextWithoutNewLines, containsString("0 points"));
            assertThat(pdfTextWithoutNewLines, containsString("6. Reasons for decision 1"));
            assertThat(pdfTextWithoutNewLines, containsString("7. Reasons for decision 2"));
    ...
    public void enhancedRateNotConsidered_shouldGeneratePdfWithExpectedText(String comparedToDwpDailyLiving, boolean allowed, boolean setAside, boolean indefinite) throws IOException {
        ...
        try (PDDocument document = PDDocument.load(bytes)) {
            ...
            assertThat(pdfTextWithoutNewLines,
                containsString("4. Joe Bloggs has severely limited ability to carry out the activities of daily living set out below. They score 12 points. They satisfy the following descriptors:"));

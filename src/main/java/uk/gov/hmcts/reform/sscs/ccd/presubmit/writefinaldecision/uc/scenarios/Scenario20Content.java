...
public class Scenario20Content extends UcTemplateContent {

    public Scenario20Content(WriteFinalDecisionTemplateBody writeFinalDecisionTemplateBody) {
        ...
        addComponent(new Paragraph(UcTemplateComponentId.SEVERE_CRITERIA_FAILED.name(), getSevereCriteriaPassedSentence()));

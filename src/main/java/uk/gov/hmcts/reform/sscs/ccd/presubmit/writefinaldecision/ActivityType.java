...
/**
 * Enum to encapsulate an ActivityType, along with bindings to the methods on
 * SscsCaseData that yield the specified award type for that ActivityType,
 * and the answers to the multi-select list of activities specified for the
 * ActivityType.
 */

 ...
 * before preview.
 */
public enum UcPointsRegulationsAndSchedule3ActivitiesCondition implements PointsCondition<UcPointsRegulationsAndSchedule3ActivitiesCondition> {
    ...
    LOW_POINTS_SCHEDULE_8_PARAGRAPH_4_DOES_NOT_APPLY(UcPointsCondition.POINTS_LESS_THAN_FIFTEEN,
        Arrays.asList(isWcaAppeal(TRUE), isSupportGroupOnly(NOT_TRUE, true), isSchedule8Paragraph4(FALSE)), Optional.of(AwardType.NO_AWARD), true, isSchedule9Paragraph4(UNSPECIFIED), isSchedule7ActivitiesAnswer(StringListPredicate.UNSPECIFIED)),
    // SCENARIO_9
    LOW_POINTS_SCHEDULE_8_PARAGRAPH_4_DOES_APPLY_SCHEDULE_9_PARAGRAPH_4_UNSPECIFIED_NON_SUPPORT_GROUP_ONLY(UcPointsCondition.POINTS_LESS_THAN_FIFTEEN,
        Arrays.asList(isWcaAppeal(TRUE), isSupportGroupOnly(NOT_TRUE, true), isSchedule8Paragraph4(TRUE), isSchedule9Paragraph4(UNSPECIFIED)), Optional.of(AwardType.HIGHER_RATE),  true, isSchedule7ActivitiesAnswer(StringListPredicate.NOT_EMPTY)),
    // SCENARIO_7
    LOW_POINTS_SCHEDULE_8_PARAGRAPH_4_DOES_APPLY_SCHEDULE_9_PARAGRAPH_4_DOES_NOT_APPLY_NON_SUPPORT_GROUP_ONLY(UcPointsCondition.POINTS_LESS_THAN_FIFTEEN,
        Arrays.asList(isWcaAppeal(TRUE), isSupportGroupOnly(NOT_TRUE, true), isSchedule8Paragraph4(TRUE), isSchedule9Paragraph4(FALSE)), Optional.of(AwardType.LOWER_RATE), true, isSchedule7ActivitiesAnswer(StringListPredicate.EMPTY)),
    // SCENARIO_8
    LOW_POINTS_SCHEDULE_8_PARAGRAPH_4_DOES_APPLY_SCHEDULE_9_PARAGRAPH_4_DOES_APPLY_NON_SUPPORT_GROUP_ONLY(UcPointsCondition.POINTS_LESS_THAN_FIFTEEN,
        Arrays.asList(isWcaAppeal(TRUE), isSupportGroupOnly(NOT_TRUE, true), isSchedule8Paragraph4(TRUE), isSchedule9Paragraph4(TRUE)), Optional.of(AwardType.HIGHER_RATE), true, isSchedule7ActivitiesAnswer(StringListPredicate.EMPTY)),
    // SCENARIO_4
    LOW_POINTS_SCHEDULE2_AND_REG_29_SKIPPED_SCHEDULE_9_PARAGRAPH_4_UNSPECIFIED_SUPPORT_GROUP_ONLY(UcPointsCondition.POINTS_LESS_THAN_FIFTEEN,
        Arrays.asList(isWcaAppeal(TRUE), isSupportGroupOnly(TRUE, true), isSchedule9Paragraph4(UNSPECIFIED)), Optional.of(AwardType.HIGHER_RATE),  false, isSchedule7ActivitiesAnswer(StringListPredicate.NOT_EMPTY), isSchedule8Paragraph4(UNSPECIFIED)),
    // SCENARIO_2
    LOW_POINTS_SCHEDULE2_AND_REG_29_SKIPPED_SCHEDULE_9_PARAGRAPH_4_DOES_NOT_APPLY_SUPPORT_GROUP_ONLY(UcPointsCondition.POINTS_LESS_THAN_FIFTEEN,
    ...
    // SCENARIO_3
    LOW_POINTS_SCHEDULE2_AND_REG_29_SKIPPED_SCHEDULE_9_PARAGRAPH_4_DOES_APPLY_SUPPORT_GROUP_ONLY(UcPointsCondition.POINTS_LESS_THAN_FIFTEEN,
    ...
    HIGH_POINTS_SCHEDULE_9_PARAGRAPH_4_UNSPECIFIED(UcPointsCondition.POINTS_GREATER_OR_EQUAL_TO_FIFTEEN,
        isWcaAppeal(TRUE), isSchedule9Paragraph4(UNSPECIFIED), Optional.of(AwardType.HIGHER_RATE), true, isSchedule8Paragraph4(UNSPECIFIED), isSupportGroupOnly(NOT_TRUE, true), isSchedule7ActivitiesAnswer(StringListPredicate.NOT_EMPTY)),
    // SCENARIO_5
    HIGH_POINTS_SCHEDULE_9_PARAGRAPH_4_DOES_NOT_APPLY(UcPointsCondition.POINTS_GREATER_OR_EQUAL_TO_FIFTEEN,
        isWcaAppeal(TRUE), isSchedule9Paragraph4(FALSE), Optional.of(AwardType.LOWER_RATE),  true, isSchedule8Paragraph4(UNSPECIFIED), isSupportGroupOnly(NOT_TRUE, true), isSchedule7ActivitiesAnswer(StringListPredicate.EMPTY)),
    // SCENARIO_5
    HIGH_POINTS_SCHEDULE_9_PARAGRAPH_4_DOES_APPLY(UcPointsCondition.POINTS_GREATER_OR_EQUAL_TO_FIFTEEN,
        isWcaAppeal(TRUE), isSchedule9Paragraph4(TRUE), Optional.of(AwardType.HIGHER_RATE),  true, isSchedule8Paragraph4(UNSPECIFIED), isSupportGroupOnly(NOT_TRUE, true), isSchedule7ActivitiesAnswer(StringListPredicate.EMPTY)),
    // SCENARIO 10
    ...
    UcPointsRegulationsAndSchedule3ActivitiesCondition(UcPointsCondition pointsCondition, YesNoFieldCondition primaryCondition1,YesNoFieldCondition primaryCondition2,
    ...
    UcPointsRegulationsAndSchedule3ActivitiesCondition(UcPointsCondition pointsCondition, List<YesNoFieldCondition> primaryConditions,
        Optional<AwardType> awardType, boolean displayPointsSatisfiedMessageOnError, FieldCondition...validationConditions) {
    ...
    @Override
    public Class<UcPointsRegulationsAndSchedule3ActivitiesCondition> getEnumClass() {
        return UcPointsRegulationsAndSchedule3ActivitiesCondition.class;
    }
    ...
    public static UcPointsRegulationsAndSchedule3ActivitiesCondition getTheSinglePassingPointsConditionForSubmittedActivitiesAndPoints(DecisionNoticeQuestionService questionService,
        SscsCaseData caseData) {
        for (UcPointsRegulationsAndSchedule3ActivitiesCondition esaPointsAndActivitiesCondition : UcPointsRegulationsAndSchedule3ActivitiesCondition.values()) {
    ...
    public static Optional<UcAllowedOrRefusedCondition> getPassingAllowedOrRefusedCondition(DecisionNoticeQuestionService questionService,
        ...
        UcPointsRegulationsAndSchedule3ActivitiesCondition condition

...
/**
 * Enum to encapsulate binding between an activity question key, and the corresponding getter method
 * on SscsCaseData that yields that answer to that question.
 */

...
public class Scenario5Content extends UcTemplateContent {
    ...
    public Scenario5Content(WriteFinalDecisionTemplateBody writeFinalDecisionTemplateBody) {
        ...
        addComponent(new Paragraph(
            UcTemplateComponentId.DOES_HAVE_LIMITED_CAPABILITY_FOR_WORK_PARAGRAPH.name(), getDoesHaveLimitedCapabilityForWorkSentence(writeFinalDecisionTemplateBody.getAppellantName(), false, false, false, false, writeFinalDecisionTemplateBody.getUcCapabilityAssessmentStartDate())));

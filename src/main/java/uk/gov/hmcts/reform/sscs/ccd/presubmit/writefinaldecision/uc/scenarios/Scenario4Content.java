...
public class Scenario4Content extends UcTemplateContent {
    ...
    public Scenario4Content(WriteFinalDecisionTemplateBody writeFinalDecisionTemplateBody) {
        ...
        addComponent(new Paragraph(
            UcTemplateComponentId.DOES_HAVE_LIMITED_CAPABILITY_FOR_WORK_PARAGRAPH.name(), getLimitedCapabilityForWorkRelatedSentence(writeFinalDecisionTemplateBody.getAppellantName(), false, writeFinalDecisionTemplateBody.getUcCapabilityAssessmentStartDate())));

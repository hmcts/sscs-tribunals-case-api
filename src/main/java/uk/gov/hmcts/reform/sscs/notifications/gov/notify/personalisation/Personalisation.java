...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.AppConstants.DAYS_STRING;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.AppConstants.DWP_ACRONYM;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.AppConstants.DWP_ACRONYM_WELSH;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.AppConstants.DWP_FIRST_TIER_AGENCY_GROUP;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.AppConstants.DWP_FIRST_TIER_AGENCY_GROUP_TITLE;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.AppConstants.HMRC_ACRONYM_WELSH;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.AppConstants.IBCA_ACRONYM_WELSH;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.AppConstants.MAC_LITERAL;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.AppConstants.SSCS5;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.AppConstants.SSCS8;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.AppConstants.TOMORROW_STRING;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.NotificationEventTypeLists.EVENTS_WITH_SUBSCRIPTION_TYPE_DOCMOSIS_TEMPLATES;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.NotificationEventTypeLists.EVENTS_WITH_SUBSCRIPTION_TYPE_EMAIL_TEMPLATES;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationConfiguration.PersonalisationKey.DISABLED_ACCESS;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationConfiguration.PersonalisationKey.HEARING_LOOP;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationConfiguration.PersonalisationKey.LANGUAGE_INTERPRETER;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationConfiguration.PersonalisationKey.OTHER_ARRANGEMENTS;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationConfiguration.PersonalisationKey.SIGN_INTERPRETER;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.BENEFIT_NAME_ACRONYM_SHORT_LITERAL;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.CREATED_DATE_WELSH;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.FIRST_TIER_AGENCY_ACRONYM_WELSH;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.FIRST_TIER_AGENCY_GROUP_TITLE;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.FIRST_TIER_AGENCY_OFFICE;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.HEARING_TYPE;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.HMC_HEARING_TYPE_LITERAL;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.INFO_REQUEST_DETAIL;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.IS_GRANTED;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.IS_IBC_CASE;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.IS_NOT_IBC_CASE;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.JOINT;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.JOINT_PARTY_APPEAL;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.JOINT_PARTY_NAME;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.ONLINE_HEARING_LINK_LITERAL;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.ONLINE_HEARING_REGISTER_LINK_LITERAL;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.ONLINE_HEARING_SIGN_IN_LINK_LITERAL;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.REGIONAL_OFFICE_POSTCODE_LITERAL;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.personalisation.SyaAppealCreatedAndReceivedPersonalisation.TWO_NEW_LINES;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.personalisation.SyaAppealCreatedAndReceivedPersonalisation.getOptionalField;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.service.LetterUtils.getNameForOtherParty;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.service.NotificationUtils.hasJointParty;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.service.NotificationUtils.hasRepresentative;

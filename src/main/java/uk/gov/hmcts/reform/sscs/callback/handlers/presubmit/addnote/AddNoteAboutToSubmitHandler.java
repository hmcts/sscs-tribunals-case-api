...
public class AddNoteAboutToSubmitHandler implements PreSubmitCallbackHandler<SscsCaseData> {
    ...
    public boolean canHandle(CallbackType callbackType, Callback<SscsCaseData> callback) {
        ...
        return callbackType.equals(ABOUT_TO_SUBMIT) && callback.getEvent() == ADD_NOTE;
    }
    ...
    public PreSubmitCallbackResponse<SscsCaseData> handle(CallbackType callbackType, Callback<SscsCaseData> callback,
        ...
        addNoteService.addNote(userAuthorisation, sscsCaseData, sscsCaseData.getTempNoteDetail());

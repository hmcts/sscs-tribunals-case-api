...
public class Scenario13Content extends EsaTemplateContent {

    public Scenario13Content(WriteFinalDecisionTemplateBody writeFinalDecisionTemplateBody) {
        ...
        addComponent(new Paragraph(EsaTemplateComponentId.SEVERE_CRITERIA_PASSED.name(), getSevereCriteriaPassedSentence()));

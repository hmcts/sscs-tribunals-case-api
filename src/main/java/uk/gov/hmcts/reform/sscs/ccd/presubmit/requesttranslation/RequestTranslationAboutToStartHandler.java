...
@Component
public class RequestTranslationAboutToStartHandler implements PreSubmitCallbackHandler<SscsCaseData> {
    ...
    public boolean canHandle(CallbackType callbackType, Callback<SscsCaseData> callback) {
        ...
        return callbackType.equals(CallbackType.ABOUT_TO_START)
                && callback.getEvent() == EventType.REQUEST_TRANSLATION_FROM_WLU;
    }

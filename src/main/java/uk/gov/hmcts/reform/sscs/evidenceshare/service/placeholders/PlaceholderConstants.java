...
public final class PlaceholderConstants {
    ...
    public static final String SHOULD_HIDE_IBCA_REFERENCE = "should_hide_ibca_reference";
    ...
    public static final String IBCA_REFERENCE_LITERAL = "ibca_reference";
    ...
    public static final String REGIONAL_OFFICE_PHONE_LITERAL = "rpc_address_phone";
    public static final String REGIONAL_OFFICE_FAX_LITERAL = "rpc_address_fax";

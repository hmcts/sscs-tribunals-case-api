...
public final class PlaceholderBuilder {
    ...
    public static JSONObject addEventPlaceHolders(Event event, JSONObject placeholdersMap,
        ...
        if (placeholdersMap != null) {
            return createPlaceHolderData(eventType, eventDate, placeholdersMap, hearings);

        }
        return placeholdersMap;
    }

    private static JSONObject createPlaceHolderData(EventType eventType, ZonedDateTime eventDate, JSONObject placeholdersMap, List<Hearing> hearings) {

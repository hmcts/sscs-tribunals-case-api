...
public class PostHearingReviewIt extends AbstractEventIt {
    ...
    public void setup() throws IOException {
        ...
        json = getJson("callback/postHearingReview.json");
        json = json.replaceFirst("invoking_event", "postHearingReview");
        when(idamService.getIdamTokens()).thenReturn(IdamTokens.builder().build());
    }

    @Test
    public void callToSubmittedHandler_willTriggerPostHearingReviewSubmittedHandler() throws Exception {

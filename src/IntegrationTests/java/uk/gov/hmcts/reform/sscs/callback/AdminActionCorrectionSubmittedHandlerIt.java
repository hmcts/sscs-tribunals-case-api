...
public class AdminActionCorrectionSubmittedHandlerIt extends AbstractEventIt {
    ...
    @Test
    public void callToSubmittedHandler_willTriggerAdminActionCorrectionSubmittedHandler() throws Exception {

...
public class NotListableIt extends AbstractEventIt {

    @Test
    public void callToMidEventCallback_willValidateTheData_WhenDueDateInFuture() throws Exception {
        setup();
        setJsonAndReplace("callback/notListableCallback.json", "DIRECTIONS_DUE_DATE_PLACEHOLDER", LocalDate.now().plus(1, ChronoUnit.DAYS).toString());
    ...
    public void callToAboutToSubmitHandler_willWriteDueDateToDirectionsDueDate() throws Exception {
        ...
        setJsonAndReplace("callback/notListableCallback.json", "DIRECTIONS_DUE_DATE_PLACEHOLDER", tomorrowDate);

...
public class DocumentConfigurationTest {
    ...
    public static Object[][] documentParameters() {
        return new Object[][] {
                ...
                {LanguagePreference.ENGLISH, EventType.ISSUE_FINAL_DECISION, Optional.of("pip"), "TB-SCS-GNO-ENG-00453.docx"},
                ...
                {LanguagePreference.WELSH, EventType.ISSUE_FINAL_DECISION, Optional.of("pip"), "TB-SCS-GNO-WEL-00485.docx"}
        };
    }

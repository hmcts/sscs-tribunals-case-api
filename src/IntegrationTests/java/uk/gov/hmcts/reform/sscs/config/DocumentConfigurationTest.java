...
public class DocumentConfigurationTest {
    ...
    public static Object[][] documentParameters() {
        return new Object[][] {
                {LanguagePreference.ENGLISH, EventType.DECISION_ISSUED, Optional.empty(), "TB-SCS-GNO-ENG-00091.docx"},
                {LanguagePreference.ENGLISH, EventType.DIRECTION_ISSUED, Optional.empty(), "TB-SCS-GNO-ENG-00091.docx"},
                {LanguagePreference.ENGLISH, EventType.ISSUE_FINAL_DECISION, Optional.of("pip"), "TB-SCS-GNO-ENG-00642.docx"},
                ...
                {LanguagePreference.WELSH, EventType.ISSUE_FINAL_DECISION, Optional.of("pip"), "TB-SCS-GNO-ENG-00642.docx"}
        };
    }

...
public class PlaceholderBuilderTest {
    ...
    public void addHearingPlaceholder() {
        ...
        ZonedDateTime decisionDateTime = BusinessDaysCalculatorService
                .getBusinessDay(now, HEARING_DECISION_LETTER_RECEIVED_MAX_DAYS);
    ...
    public void addHearingBookedPlaceholderWhenHearingDateAndEventDateAreOnSameDay() {
        ZonedDateTime hearingDateTime = ZonedDateTime
                .parse("2017-12-01T12:00:00.123Z", DateTimeFormatter.ISO_ZONED_DATE_TIME);
        ZonedDateTime eventDateTime = ZonedDateTime
                .parse("2017-12-01T16:00:00.123Z", DateTimeFormatter.ISO_ZONED_DATE_TIME);

        Address address = new Address("The court house", "",
                "Farndon", "Chester", "CH1 6YT", "http://chester.com");
    ...
    public void doNotGenerateHearingBookedPlaceholderWhenHearingTimeAndEventTimeAreNotOnSameDay() {
        ZonedDateTime hearingDateTime = ZonedDateTime
                .parse("2017-12-01T12:00:00.123Z", DateTimeFormatter.ISO_ZONED_DATE_TIME);
        ZonedDateTime eventDateTime = ZonedDateTime
                .parse("2017-12-02T16:00:00.123Z", DateTimeFormatter.ISO_ZONED_DATE_TIME);
    ...
    public void addHearingBookedPlaceholderWithGmtTime() {
        ZonedDateTime hearingDateTime = ZonedDateTime
                .parse("2017-12-01T12:00:00.123+00:00", DateTimeFormatter.ISO_ZONED_DATE_TIME);
        ZonedDateTime eventDateTime = ZonedDateTime
                .parse("2017-12-01T16:00:00.123+00:00", DateTimeFormatter.ISO_ZONED_DATE_TIME);

        Address address = new Address("Chester court", "The court house",
                "Farndon", "Chester", "CH1 6YT", "http://chester.com");
        Hearing hearing = new Hearing(address, hearingDateTime);
    ...
    public void addHearingBookedPlaceholderWithBstTime() {
        ZonedDateTime hearingDateTime = ZonedDateTime
                .parse("2017-08-01T12:00:00.123+01:00", DateTimeFormatter.ISO_ZONED_DATE_TIME);
        ZonedDateTime eventDateTime = ZonedDateTime
                .parse("2017-08-01T16:00:00.123+01:00", DateTimeFormatter.ISO_ZONED_DATE_TIME);

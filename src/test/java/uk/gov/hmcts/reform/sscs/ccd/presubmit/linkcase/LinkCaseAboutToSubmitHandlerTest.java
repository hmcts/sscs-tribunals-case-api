...
public class LinkCaseAboutToSubmitHandlerTest {
    ...
    public void givenCaseAWithLinkedCaseB_thenLinkCaseBBackToCaseA() {
        ...
        verify(ccdService).updateCaseV2(eq(2L), eq(CASE_UPDATED.getCcdType()), eq("Case updated"), eq("Linked case added"), any(), capture.capture());
    ...
    public void givenCaseBAlreadyLinkedToCaseA_thenDoNotUpdateCaseB() {
        ...
        verify(ccdService, times(0)).updateCaseV2(any(), eq(CASE_UPDATED.getCcdType()), eq("Case updated"), eq("Linked case added"), any(), any(Consumer.class));
    }
    ...
    public void givenCaseAWithLinkedCaseBAndC_thenLinkCaseBAndCaseCBackToCaseA() {
        ...
        verify(ccdService).updateCaseV2(eq(3L), eq(CASE_UPDATED.getCcdType()), eq("Case updated"), eq("Linked case added"), any(), capture.capture());
    ...
    public void givenCaseAWithLinkedCaseBAndCaseBLinkedToCaseC_thenLinkAllCases() {
        ...
        verify(ccdService, times(0)).updateCaseV2(eq(1L), eq(CASE_UPDATED.getCcdType()), eq("Case updated"), eq("Linked case added"), any(), any(Consumer.class));
        verify(ccdService).updateCaseV2(eq(2L), eq(CASE_UPDATED.getCcdType()), eq("Case updated"), eq("Linked case added"), any(), capture.capture());
        verify(ccdService).updateCaseV2(eq(3L), eq(CASE_UPDATED.getCcdType()), eq("Case updated"), eq("Linked case added"), any(), capture.capture());
    ...
    public void givenCaseAWithLinkedCaseBAndCaseBLinkedToCaseCAndCaseCLinkedToCaseD_thenLinkAllCases() {
        ...
        verify(ccdService).updateCaseV2(eq(2L), eq(CASE_UPDATED.getCcdType()), eq("Case updated"), eq("Linked case added"), any(), capture.capture());
        verify(ccdService).updateCaseV2(eq(3L), eq(CASE_UPDATED.getCcdType()), eq("Case updated"), eq("Linked case added"), any(), capture.capture());
        verify(ccdService).updateCaseV2(eq(4L), eq(CASE_UPDATED.getCcdType()), eq("Case updated"), eq("Linked case added"), any(), capture.capture());

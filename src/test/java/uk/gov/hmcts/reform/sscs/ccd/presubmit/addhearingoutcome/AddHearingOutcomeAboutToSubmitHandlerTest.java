...
public class AddHearingOutcomeAboutToSubmitHandlerTest {
    ...
    public void setUp() {
        openMocks(this);
        ReflectionTestUtils.setField(handler, "isAddHearingOutcomeEnabled", true);
    ...
    @Test
    public void givenIsAddHearingOutcomeEnabledFalse_thenReturnFalse() {
        ReflectionTestUtils.setField(handler, "isAddHearingOutcomeEnabled", false);

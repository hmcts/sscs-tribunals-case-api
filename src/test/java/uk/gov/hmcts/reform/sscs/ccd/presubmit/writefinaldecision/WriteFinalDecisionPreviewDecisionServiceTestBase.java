...
public abstract class WriteFinalDecisionPreviewDecisionServiceTestBase {
    ...
    public void setUp() throws IOException {
        ...
        englishEventTypeDocs.put(EventType.CORRECTION_GRANTED, "TB-SCS-GNO-ENG-corrected-decision-notice-v2.docx");
        ...
        welshEventTypeDocs.put(EventType.CORRECTION_GRANTED, "TB-SCS-GNO-ENG-corrected-decision-notice-v2.docx");
        welshEventTypeDocs.put(EventType.DIRECTION_ISSUED, "TB-SCS-GNO-ENG-directions-notice-v2.docx");
        welshEventTypeDocs.put(EventType.DECISION_ISSUED, "TB-SCS-GNO-ENG-draft-decision-notice-v2.docx");
    ...
    public void givenPostHearingIsEnabledAndFinalHeldAtHasBeenSet_thenDontUpdateFinalDecisionHeldAt() {
        ...
        sscsCaseData.getSscsFinalDecisionCaseData().setFinalDecisionHeldAt("venue 1 name");
        ...
        assertEquals("venue 1 name", response.getData().getSscsFinalDecisionCaseData().getFinalDecisionHeldAt());
    }

    @Test
    public void givenCorrectionNotInProgressAndFinalHeldAtHasBeenSet_thenUpdateFinalDecisionHeldAt() {
        when(caseDetails.getState()).thenReturn(State.POST_HEARING);

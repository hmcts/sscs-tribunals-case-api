...
public class FeHandledOfflineHandlerTest {
    ...
    private static final SscsDocument noIssuedDoc = SscsDocument.builder()
        .value(SscsDocumentDetails.builder()
            .documentType("Appellant evidence")
            .evidenceIssued("No")
            .build())
        .build();
    private static final SscsDocument issuedDoc = SscsDocument.builder()
        .value(SscsDocumentDetails.builder()
            .documentType("Representative evidence")
            .evidenceIssued("Yes")
            .build())
        .build();
    private static final SscsDocument dl16Doc = SscsDocument.builder()
        .value(SscsDocumentDetails.builder()
            .documentType("DL16")
            .build())
        .build();

...
public class NewUcScenario1Test {
    ...
    public void testScenario1() {
        ...
        String expectedContent = "The appeal is refused.\n"
            ...
            + "\n"
            + "In applying the Work Capability Assessment 9 points were scored from the activities and descriptors in Schedule 6 of the UC Regulations 2013. This is insufficient to the threshold for the test. Schedule 8, paragraph 4 of the UC Regulation 2013 did not apply.\n"
            + "\n"
    ...
    public void testScenario1NoSchedule6() {
        ...
        String expectedContent = "The appeal is refused.\n"
            ...
            + "Felix Sydney does not have limited capability for work. The matter is now remitted to the Secretary of State to make a final decision upon entitlement to UC.\n"
            + "\n"
            + "In applying the Work Capability Assessment 0 points were scored from the activities and descriptors in Schedule 6 of the UC Regulations 2013. This is insufficient to the threshold for the test. Schedule 8, paragraph 4 of the UC Regulation 2013 did not apply.\n"
            + "\n"
            + "My first reasons\n"
            + "\n"
            + "My second reasons\n"

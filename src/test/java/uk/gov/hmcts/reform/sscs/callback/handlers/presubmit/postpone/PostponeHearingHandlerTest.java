package uk.gov.hmcts.reform.sscs.callback.handlers.presubmit.postpone;
...
import uk.gov.hmcts.reform.sscs.callback.handlers.presubmit.postpone.PostponeHearingHandler;
...
public class PostponeHearingHandlerTest {
    ...
    public void handleReadyToListPostponementRelistEventType() {
        ...
        assertThat(sscsCaseData.getPostponement()).isNotNull();

...
public class UcScenario6Test {
    ...
    public void testScenario6() {
        ...
        List<Descriptor> schedule7Descriptors = singletonList(Descriptor.builder().activityQuestionValue("My schedule 3 descriptor").build());
        ...
        String expectedContent = """
            ...
            Felix Sydney has limited capability for work and for work-related activity from 18/11/2025.

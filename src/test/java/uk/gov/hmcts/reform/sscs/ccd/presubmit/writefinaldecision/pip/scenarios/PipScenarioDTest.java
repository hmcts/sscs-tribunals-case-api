...
public class PipScenarioDTest {
    ...
    public void testScenario1() {
        ...
        String expectedContent = "The appeal is refused.\n"
            ...
            + "Something else\n"
            + "\n"
            + "Felix Sydney attended the hearing today and the tribunal considered the appeal bundle to page A1. No Presenting Officer attended on behalf of the Respondent.\n"
            + "\n";

...
public class SubmitYourAppealToCcdCaseDataDeserializerTest {
    ...
    @Parameters({"DWP PIP ( 9),PIP,DWP PIP (9)", "null,carersAllowance,Carer’s Allowance"})
    @Test
    ...
    @Parameters({
        ...
        "null,carersAllowance,Carer’s Allowance", "DWP PIP (5),carersAllowance,Carer’s Allowance"
    })
    @Test

...
import uk.gov.hmcts.reform.sscs.callback.handlers.presubmit.updateotherparty.UpdateOtherPartyAboutToSubmitHandler;
...
public class UpdateOtherPartyAboutToSubmitHandlerTest {
    ...
    @Test
    public void givenSscsIbaCaseOtherPartyWithRoleEntered_thenNoRoleCheck() {
        SscsCaseData sscsCaseData = SscsCaseData.builder()
            .appeal(

...
public class EsaPointsRegulationsAndSchedule3ActivitiesConditionTest {
            ...
            for (boolean allowed : Arrays.asList(false, true)) {
                ...
                for (int points = minPointsValue; points <= maxPointsValue; points++) {
                    ...
                    Assertions.assertEquals(
                        1, conditionApplicableCount, "Expected 1 condition to be satisfied for points:" + points + ":" + wcaAppeal + ":" + doesRegulation29Apply + ":" + schedule3ActivitiesSelected + ":" + doesRegulation35Apply + ":" + supportGroupOnly +  " but "
                            + conditionApplicableCount + " were satisfied");

                    if (isValidCombinationExpected) {

                        Assertions.assertTrue(matchingCondition
                            .getOptionalErrorMessage(questionService, caseData).isEmpty(), "Unexpected error for:" + points + ":" + wcaAppeal + ":" + doesRegulation29Apply
                            + ":" + schedule3ActivitiesSelected + ":" + doesRegulation35Apply + ":" + supportGroupOnly);
                    } else {
                        Assertions.assertTrue(matchingCondition
                            .getOptionalErrorMessage(questionService, caseData).isPresent(), "Expected an error for:" + points + ":" + wcaAppeal + ":" + doesRegulation29Apply
                            + ":" + schedule3ActivitiesSelected + ":" + doesRegulation35Apply + ":" + supportGroupOnly);
                    }
                    ...
                    if (matchingCondition != null && matchingCondition
                        ...
                        Assertions.assertEquals(
                            1, allowedOrRefusedConditionApplicableCount, "Expected 1 allowed or refused condition to be satisfied for points:" + points + ":" + wcaAppeal + ":" + doesRegulation29Apply + ":" + schedule3ActivitiesSelected + ":" + doesRegulation35Apply + ":" + allowed
    ...
    public void testAllPointsConditionAttributesAreNotNull() {
        for (EsaPointsRegulationsAndSchedule3ActivitiesCondition esaPointsCondition : EsaPointsRegulationsAndSchedule3ActivitiesCondition.values()) {
            Assertions.assertNotNull(esaPointsCondition.getAnswersExtractor());
            Assertions.assertSame(esaPointsCondition.getAnswersExtractor(), EsaPointsRegulationsAndSchedule3ActivitiesCondition.getAllAnswersExtractor());
            Assertions.assertNotNull(esaPointsCondition.getEnumClass());
            Assertions.assertEquals(EsaPointsRegulationsAndSchedule3ActivitiesCondition.class, esaPointsCondition.getEnumClass());

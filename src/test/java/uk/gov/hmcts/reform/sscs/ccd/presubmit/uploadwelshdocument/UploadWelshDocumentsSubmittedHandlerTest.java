...
public class UploadWelshDocumentsSubmittedHandlerTest {
    ...
    public void shouldCallUpdateCaseWithCorrectEvent() {
        ...
        when(ccdService.updateCase(caseData, callback.getCaseDetails().getId(), EventType.SEND_TO_DWP.getCcdType(), "Upload welsh document",
                "Upload welsh document", idamTokens)).thenReturn(SscsCaseDetails.builder().data(SscsCaseData.builder().build()).build());

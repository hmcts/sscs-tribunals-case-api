...
public class UcPointsRegulationsAndSchedule3ActivitiesConditionTest {
                ...
                for (int points = minPointsValue; points <= maxPointsValue; points++) {
                    ...
                    if (wcaAppeal.booleanValue()) {
                        ...
                        caseData = SscsCaseData.builder()
                            ...
                            .sscsUcCaseData(
                                SscsUcCaseData.builder().ucWriteFinalDecisionSchedule7ActivitiesApply(schedule3ActivitesApply)
                                    .ucWriteFinalDecisionSchedule7ActivitiesQuestion(schedule3Activities)
                                    .doesSchedule8Paragraph4Apply(getYesNoFieldValue(doesRegulation29Apply))
                                    .doesSchedule9Paragraph4Apply(getYesNoFieldValue(doesRegulation35Apply)).build()).build();
                    } else {
                        caseData = SscsCaseData.builder()
                            .wcaAppeal("No")
                            .writeFinalDecisionGenerateNotice("Yes")
                            ...
                            .sscsUcCaseData(
                                SscsUcCaseData.builder().ucWriteFinalDecisionSchedule7ActivitiesApply(schedule3ActivitesApply)
                                    .ucWriteFinalDecisionSchedule7ActivitiesQuestion(schedule3Activities).build()).build();
                    }

                    Mockito.when(questionService.getTotalPoints(Mockito.eq(caseData), Mockito.any())).thenReturn(points);

                    UcPointsRegulationsAndSchedule3ActivitiesCondition matchingCondition = null;

                    for (UcPointsRegulationsAndSchedule3ActivitiesCondition esaPointsCondition : UcPointsRegulationsAndSchedule3ActivitiesCondition.values()) {
    ...
    public void testAllPointsConditionAttributesAreNotNull() {
        for (UcPointsRegulationsAndSchedule3ActivitiesCondition esaPointsCondition : UcPointsRegulationsAndSchedule3ActivitiesCondition.values()) {
            ...
            Assert.assertSame(esaPointsCondition.getAnswersExtractor(), UcPointsRegulationsAndSchedule3ActivitiesCondition.getAllAnswersExtractor());
            Assert.assertNotNull(esaPointsCondition.getEnumClass());
            Assert.assertEquals(UcPointsRegulationsAndSchedule3ActivitiesCondition.class, esaPointsCondition.getEnumClass());

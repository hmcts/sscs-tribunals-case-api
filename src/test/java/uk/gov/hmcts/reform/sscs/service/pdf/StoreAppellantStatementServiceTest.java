...
public class StoreAppellantStatementServiceTest {
    ...
    @ParameterizedTest
    @MethodSource("generateDifferentCaseDataScenarios")
    ...
    private static Object[] generateDifferentCaseDataScenarios() {
    ...
    private static SscsCaseData buildCaseDataWithNoDocsAndWithGivenSubs(Subscription appellantSubscription, Subscription representativeSubscription) {
    ...
    @NotNull
    private static SscsCaseData buildCaseDataWithRepStatementAndGivenSubs(Subscription appellantSubscription,
    ...
    private static SscsCaseData buildCaseDataWithSscsDocumentAndGivenScannedDocumentFilename(String scannedDocFilename) {
        return SscsCaseData.builder()
                .scannedDocuments(singletonList(ScannedDocument.builder()
                        .value(ScannedDocumentDetails.builder()

...
public class ConfirmPanelCompositionAboutToSubmitHandlerTest {
    ...
    @Test
    public void givenFqpmRequiredYes_thenPanelMemberCompositionHasFqpm() {
        ...
        assertThat(response.getData().getPanelMemberComposition().getPanelCompDisabilityAndFqm(),
            hasItem(PanelMemberType.TRIBUNAL_MEMBER_FINANCIALLY_QUALIFIED.getReference()));
    }
    ...
    public void givenFqpmRequiredNo_thenPanelMemberCompositionHasNoFqpm() {
        ...
        assertThat(response.getData().getPanelMemberComposition().getPanelCompDisabilityAndFqm(),
            not(hasItem(PanelMemberType.TRIBUNAL_MEMBER_FINANCIALLY_QUALIFIED.getReference())));
    }

...
public class UcScenario4Test {
    ...
    public void testScenario4() {
        List<Descriptor> schedule7Descriptors =
            singletonList(Descriptor.builder()
                              .activityQuestionValue(
                                  "12. Coping with change. Cannot cope with any change, due to cognitive impairment or mental disorder, to the extent that day to day life cannot be managed.").build());
        ...
        String expectedContent = """
            ...
            Felix Sydney has limited capability for work-related activity from %s.

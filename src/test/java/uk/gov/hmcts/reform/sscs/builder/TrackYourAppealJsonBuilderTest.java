...
public class TrackYourAppealJsonBuilderTest {
    ...
    public void createdInGapsFromTest() {
        ...
        ObjectNode objectNode = trackYourAppealJsonBuilder.build(caseData, populateRegionalProcessingCenter(), 1L, true, "appealReceived");
    ...
    public void appealReceivedTest() throws CcdException {
        ...
        ObjectNode objectNode = trackYourAppealJsonBuilder.build(caseData,
            populateRegionalProcessingCenter(), 1L, true, "appealReceived");
    ...
    public void noEventsTest() throws CcdException {
        ...
        trackYourAppealJsonBuilder.build(caseData, populateRegionalProcessingCenter(), 1L, true, "appealReceived");
    }

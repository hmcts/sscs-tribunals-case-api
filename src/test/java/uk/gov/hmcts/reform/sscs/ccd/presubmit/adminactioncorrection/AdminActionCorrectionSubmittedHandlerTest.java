...
import uk.gov.hmcts.reform.sscs.ccd.presubmit.posthearingrequest.PostHearingRequestSubmittedHandler;
...
class AdminActionCorrectionSubmittedHandlerTest {
    ...
    private AdminActionCorrectionSubmittedCallbackHandler handler;
    ...
    @BeforeEach
    void setUp() {
        handler = new AdminActionCorrectionSubmittedCallbackHandler(ccdCallbackMapService, true);
    ...
    void givenPostHearingsEnabledFalse_thenReturnFalse() {
        handler = new AdminActionCorrectionSubmittedCallbackHandler(ccdCallbackMapService, false);
        when(callback.getEvent()).thenReturn(ADMIN_ACTION_CORRECTION);
        assertThat(handler.canHandle(SUBMITTED, callback)).isFalse();
    }

...
class EsaScenarioHearingTypeTest {

    private static Stream<Arguments> allNextHearingTypeParameters() {
        return Stream.of(
            Arguments.of("triage", false, false, "The tribunal considered the appeal bundle to page A1.\n"),
    ...
    void testScenario3(String hearingType, boolean appellantAttended, boolean presentingOfficerAttended, String expectedHearingType) {
        ...
        assertEquals(appellantAttended || "triage".equals(hearingType) ? 10 : 11, content.getComponents().size());

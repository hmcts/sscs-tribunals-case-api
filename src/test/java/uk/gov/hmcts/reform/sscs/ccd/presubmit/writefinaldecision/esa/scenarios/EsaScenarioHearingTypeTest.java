...
public class EsaScenarioHearingTypeTest {
    ...
    private Object[] allNextHearingTypeParameters() {
        return new Object[] {
            ...
            new Object[] {"telephone", true, true, "This has been a remote hearing in the form of a telephone hearing. Felix Sydney attended the hearing today and gave oral evidence which was considered by the Tribunal together with the appeal bundle to page A1.  A Presenting Officer attended on behalf of the Respondent.\n"},
            new Object[] {"telephone", true, false, "This has been a remote hearing in the form of a telephone hearing. Felix Sydney attended the hearing today and gave oral evidence which was considered by the Tribunal together with the appeal bundle to page A1.  No Presenting Officer attended on behalf of the Respondent.\n"},
            ...
            new Object[] {"telephone", false, false, "This has been a remote hearing in the form of a telephone hearing. Felix Sydney did not attend the hearing today. No Presenting Officer attended on behalf of the Respondent.\n"
                    + "\n"
                    + "Having considered the appeal bundle to page A1 and the requirements of rules 2 and 31 of The Tribunal Procedure (First-tier Tribunal)(Social Entitlement Chamber) Rules 2008 the Tribunal is satisfied that reasonable steps were taken to notify Felix Sydney of the hearing and that it is in the interests of justice to proceed today.  \n"},
            new Object[] {"video", true, true, "This has been a remote hearing in the form of a video hearing. Felix Sydney attended the hearing today and gave oral evidence which was considered by the Tribunal together with the appeal bundle to page A1.  A Presenting Officer attended on behalf of the Respondent.\n"},
            new Object[] {"video", true, false, "This has been a remote hearing in the form of a video hearing. Felix Sydney attended the hearing today and gave oral evidence which was considered by the Tribunal together with the appeal bundle to page A1.  No Presenting Officer attended on behalf of the Respondent.\n"},

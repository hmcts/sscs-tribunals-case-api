...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.ADDRESS_LINE_3;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.ADDRESS_LINE_4;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.config.PersonalisationMappingConstants.ADDRESS_LINE_5;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.domain.notify.NotificationEventType.LIBERTY_TO_APPLY_REQUEST;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.service.LetterUtils.LetterType.GOV_NOTIFY;
...
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.service.LetterUtils.lines;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.service.NotificationDispatchServiceTest.APPELLANT_WITH_ADDRESS_AND_APPOINTEE;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.service.NotificationDispatchServiceTest.REP_WITH_ADDRESS;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.service.NotificationProcessingServiceTest.APPELLANT_WITH_ADDRESS;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.service.NotificationProcessingServiceTest.buildBaseWrapper;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.service.NotificationProcessingServiceTest.buildBaseWrapperJointParty;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.service.NotificationProcessingServiceTest.buildBaseWrapperOtherParty;
import static uk.gov.hmcts.reform.sscs.notifications.gov.notify.service.NotificationProcessingServiceTest.buildBaseWrapperWithReasonableAdjustment;
...
public class LetterUtilsTest {
    ...
    @Test
    public void lines_returns_expected_for_short_UK_address() {
        Address testAddress = Address.builder()
                .line1("Elba")
                .town("Duns")
                .postcode("TD11 3RY")
    ...
    @Test
    public void getAddressPlaceholders_returnsExpectedValuesUkAddress() {
        Address testAddress = Address.builder()
                .line1("Somerset House")
                .line2("Strand")
                .town("London")
        ...
        assertEquals("London", placeholders.get(LETTER_ADDRESS_LINE_3));
        assertEquals("Greater London", placeholders.get(LETTER_ADDRESS_LINE_4));
        assertEquals("WC2R 1LA", placeholders.get(LETTER_ADDRESS_POSTCODE));
    }

    @DisplayName("getAddressPlaceholders returns expected values for a UK address.")
    @Test
    public void getAddressPlaceholders_returnsExpectedValuesShortUkAddress() {
        Address testAddress = Address.builder()
                .line1("Elba")
                .town("Duns")
                .postcode("TD11 3RY")
        ...
        assertEquals("TD11 3RY", placeholders.get(LETTER_ADDRESS_LINE_3));
    }
    ...
    @Test
    public void getAddressPlaceholders_returnsExpectedValuesWhenUsingSendLetterNotificationToAddressPlaceholders() {
    ...
    @Test
    public void getAddressPlaceholders_returnsExpectedValuesInternationalAddress() {
        Address testAddress = Address.builder()
                .line1("Catherdrale Notre-Dame de Paris")
                .line2("6 Parvis Notre-dame - Pl. Jean-Paul II")
                .town("Paris")
        ...
        assertEquals("Paris", placeholders.get(LETTER_ADDRESS_LINE_3));
        assertEquals("France", placeholders.get(LETTER_ADDRESS_LINE_4));
    }
    ...
    public void getAddressPlaceholders_returnsExpectedValuesInternationalAddressNoPostcode() {
        ...
        assertEquals("6 Parvis Notre-dame - Pl. Jean-Paul II", placeholders.get(LETTER_ADDRESS_LINE_2));
        assertEquals("Paris", placeholders.get(LETTER_ADDRESS_LINE_3));
        assertEquals("75004", placeholders.get(LETTER_ADDRESS_LINE_4));
        assertEquals("France", placeholders.get(LETTER_ADDRESS_POSTCODE));
    ...
    @Test
    public void getAddressPlaceholders_truncatesLongAddressLinesWhenTruncateTrue() {
        Address testAddress = Address.builder()
                .line1("This is a very long test address, it should be truncated to a shorter string when getAddressPlaceholders truncate argument is true")
                .line2("Test Street")
                .town("Test Town")
                .county("Test County")
                .postcode("TT1 1TT")
        ...
        assertEquals("Test County", placeholders.get(ADDRESS_LINE_5));
        assertEquals("TT1 1TT", placeholders.get(POSTCODE_LITERAL));
    }

    @DisplayName("getAddressPlaceholders keeps address lines long when truncate is false.")
    @Test
    public void getAddressPlaceholders_keepsLongAddressLinesWhenTruncateFalse() {
        Address testAddress = Address.builder()
                .line1("This is a very long test address, it should be long string when getAddressPlaceholders truncate argument is false")
                .line2("Test Street")
                .town("Test Town")
                .county("Test County")
                .postcode("TT1 1TT")

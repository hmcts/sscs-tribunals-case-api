...
public class RequestTranslationAboutToStartHandlerTest {

    private static final String USER_AUTHORISATION = "Bearer token";

    private RequestTranslationAboutToStartHandler handler;
    ...
    public void setUp() {
        ...
        handler = new RequestTranslationAboutToStartHandler();
        when(callback.getEvent()).thenReturn(EventType.REQUEST_TRANSLATION_FROM_WLU);

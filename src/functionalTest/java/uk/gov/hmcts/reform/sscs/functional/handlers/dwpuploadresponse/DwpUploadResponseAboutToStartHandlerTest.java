...
public class DwpUploadResponseAboutToStartHandlerTest extends BaseHandler {
    ...
    public void givenAboutToStartCallback_shouldReturnDwpFurtherInfo() throws Exception {
        ...
        RestAssured.given()
                ...
                .log().all(true)
                .assertThat()
                .body("data.ftaResponseReviewRequired", equalTo("Yes"))
                .body("data.dwpFurtherInfo", equalTo("Yes"))
                .body("data.dwpResponseDocument.documentLink.document_url",
                        equalTo("http://dm-store:5005/documents/6a7cc2b4-2a32-468d-a3e9-d394b0503a26"))

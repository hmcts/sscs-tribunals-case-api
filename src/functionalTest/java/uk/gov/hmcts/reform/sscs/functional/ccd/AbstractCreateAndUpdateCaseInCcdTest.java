...
@SpringBootTest
public abstract class AbstractCreateAndUpdateCaseInCcdTest {
    ...
    public abstract SscsCaseData callConvertSyaToCcdCaseDataRelevantVersion(SyaCaseWrapper syaCaseWrapper, String region, RegionalProcessingCenter rpc, boolean caseAccessManagementEnabled);

    public abstract SscsCaseData callConvertSyaToCcdCaseDataRelevantVersion(SyaCaseWrapper syaCaseWrapper, boolean caseAccessManagementEnabled);
    ...
    public void givenASyaCase_shouldBeSavedIntoCcdInCorrectState() {
        ...
        SscsCaseData caseData = callConvertSyaToCcdCaseDataRelevantVersion(syaCaseWrapper, rpc.getName(), rpc, false);

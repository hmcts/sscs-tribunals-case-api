...
public class EvidenceUploadTest extends BaseFunctionTest {
    ...
    public void uploadSingleEvidence() throws IOException, JSONException, InterruptedException {
        ...
        assertThat(scannedDocument.getFirst().getValue().getFileName(), is(expectedEvidenceUploadFilename));
    }
    ...
    public void uploadAudioThenSubmitEvidenceToAppeal() throws IOException, JSONException, InterruptedException {
        ...
        assertThat(audioVideoEvidences.getFirst().getValue().getFileName(), is("evidence.mp3"));

        String expectedEvidenceUploadFilename = String.format("Appellant upload 1 - %s.pdf", caseDetails.getId());
        assertThat(audioVideoEvidences.getFirst().getValue().getStatementOfEvidencePdf().getDocumentFilename(), is(expectedEvidenceUploadFilename));
    }

...
public class AdjournCaseAboutToSubmitHandlerTest extends BaseHandler {
    ...
    public void testGaps() throws IOException {
        ...
        assertThat(adjournment.getDisabilityQualifiedPanelMemberName().getValue().getLabel()).isEqualTo("Bob Smith");
        ...
        assertThat(adjournment.getMedicallyQualifiedPanelMemberName().getValue().getLabel()).isEqualTo("Wendy Rowe");
        ...
        assertThat(adjournment.getOtherPanelMemberName().getValue().getLabel()).isEqualTo("The Doctor");

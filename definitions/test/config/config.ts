...
export const urls = {
  ...
  tribunalsApiUri: process.env.TEST_E2E_API_URI || 'https://sscs-tribunals-api-pr-${CHANGE_ID}.preview.platform.hmcts.net',
  xuiUrl: process.env.TEST_E2E_URL_WEB || 'https://xui-sscs-tribunals-api-pr-${CHANGE_ID}.preview.platform.hmcts.net',

...
export const credentials = {
  ...
  seniorCaseworker: {
    ...
    password: process.env.SENIOR_CASEWORKER_PASSWORD
  },
  hearingCentreAdmin: {
    email: process.env.HEARING_CENTRE_ADMIN_USERNAME,
    password: process.env.HEARING_CENTRE_ADMIN_PASSWORD
  },
  hearingCentreTeamLead: {
    email: process.env.HEARING_CENTRE_TEAM_LEAD_USERNAME,
    password: process.env.HEARING_CENTRE_TEAM_LEAD_PASSWORD
  },
  judge: {
  ...
  amSeniorTribunalCaseWorkerWithCaseAllocatorRole: {
    email:
      process.env.TEST_AM_SENIOR_TRIBUNAL_CASEWORKER_CASE_ALLOCATOR_USERNAME,
    password:
      process.env.TEST_AM_SENIOR_TRIBUNAL_CASEWORKER_CASE_ALLOCATOR_PASSWORD
  },
...
export const paths = {
  ...
  testPdfFile: path.resolve(__dirname, '../tests/fixtures/file/mockFile.pdf'),
  testWordFile: path.resolve(__dirname, '../tests/fixtures/file/mockFile.docx'),
  testOdtFile: path.resolve(__dirname, '../tests/fixtures/file/mockFile.odt')
};

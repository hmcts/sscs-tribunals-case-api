...
export class AddHearingPage {
  ...
  async submitHearing(
    hearingState: string = 'Hearing is Completed'
  ): Promise<void> {
    ...
    await webActions.inputField(
      '#hearings_0_venue_address_county',
      'test county'
    );
    await webActions.inputField(
      '#hearings_0_venue_address_postcode',
      'TS3 3ST'
    );

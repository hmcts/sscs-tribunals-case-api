...
export class UploadDocumentPage {
  ...
  async uploadFEDocument() {
    await webActions.verifyPageLabel(
      'h1.govuk-heading-l',
      'Upload further evidence documents'
    );
    ...
    await webActions.inputField(
      '#draftSscsFurtherEvidenceDocument_0_documentFileName',
      'testfile'
    );
    ...
    await webActions.chooseOptionByLabel(
      '#requestableHearingDetails',
      'Fox court 13:00 20 Feb 2024'
    );
    await webActions.clickSubmitButton();

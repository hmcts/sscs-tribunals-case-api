...
export class ReissueFurtherEvidencePage {
  ...
  async applyActionFurtherEvidence() {
    ...
    await this.page
      .locator('#furtherEvidenceAction')
      .selectOption('2: otherDocumentManual');
    await this.page.locator('#originalSender').selectOption('1: appellant');
    await this.page.getByRole('button', { name: 'Add New' }).click();
    await this.page
      .locator('#scannedDocuments_0_fileName')
      .fill(reissueFurtherEvidenceData.reissueFurtherEvidenceFileName);
  ...
  async applyReissueFurtherEvidence() {
    ...
    await this.page
      .locator('#reissueFurtherEvidenceDocument')
      .selectOption('1: http://dm-store-aat.service.core-compute-aat.in');

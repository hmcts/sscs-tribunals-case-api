...
test.describe.serial(
  ...
  async () => {
    ...
    test('CTSC Admin as allocated case worker, views the Action Unprocessed Correspondence task', async ({
      ...
      test.slow();
      await supplementaryResponseSteps.verifyCtscAdminAsAllocatedCaseWorkerCanViewTheAutomaticallyAssignedActionUnprocessedCorrespondenceTask(
        caseId
      );
    });
    ...
    test('CTSC Admin as allocated case worker, completes the Action Unprocessed Correspondence task', async ({
      ...
      test.slow();
      await supplementaryResponseSteps.verifyCtscAdminAsAllocatedCaseWorkerCanCompleteTheAssignedActionUnprocessedCorrespondenceTask(
        caseId
      );
    });
...
test.describe.serial(
  ...
  async () => {
    ...
    test('CTSC Admin as allocated case worker, cancels the Action Unprocessed Correspondence CTSC task manually', async ({
      ...
      test.slow();
      await supplementaryResponseSteps.verifyActionUnprocessedCorrespondenceTaskCanBeCancelledManuallyByAllocatedCtscAdmin(
        caseId
      );
    });

...
test.describe('Urgent hearing test', async () => {
  ...
  test(
    'Error scenario - Upload encrypted file in Action further evidence event',
    { tag: ['@preview-regression', '@nightly-pipeline'] },
    async ({ urgentHearingSteps }) => {
      test.slow();
...
test.describe.serial(
  'WA - Review Urgent Hearing Request - Judge task initiation and completion tests by Interlocutory Judge',
  {
    tag: '@work-allocation'
  },
  async () => {
    ...
    test('As an Interlocutory Judge, view the auto assigned Review Urgent Hearing Request task', async ({
      ...
      test.slow();
      await urgentHearingSteps.verifyInterlocutoryJudgeCanViewTheAssignedReviewUrgentHearingRequestTask(
        caseId
      );
    });
    ...
    test('As an Interlocutory Judge, complete the auto assigned Review Urgent Hearing Request task', async ({
      ...
      test.slow();
      await urgentHearingSteps.verifyInterlocutoryJudgeCanCompleteTheAssignedReviewUrgentHearingRequestTask(
        caseId
      );
    });
...
test.describe.serial(
  'WA - Review Urgent Hearing Request - Judge task initiation and completion tests by Salaried Judge',
  {
    tag: '@work-allocation'
  },
  async () => {
    ...
    test('As a Salaried Judge, view the Review Urgent Hearing Request - Judge task', async ({
      ...
      test.slow();
      await urgentHearingSteps.verifySalariedJudgeCanViewTheUnassignedReviewUrgentHearingRequestTask(
        caseId
      );
    });
    ...
    test('As a Salaried Judge, complete the Review Urgent Hearing Request - Judge task', async ({
      ...
      test.slow();
      await urgentHearingSteps.verifySalariedJudgeCanCompleteTheUnassignedReviewUrgentHearingRequestTask(
        caseId
      );
    });
...
test.describe.serial(
  'WA - Review Urgent Hearing Request - Judge task initiation and completion tests by Fee-Paid Judge',
  {
    tag: '@work-allocation'
  },
  async () => {
    ...
    test('As a Fee-Paid Judge, view the Review Urgent Hearing Request - Judge task', async ({
      ...
      test.slow();
      await urgentHearingSteps.verifyFeePaidJudgeCanViewTheUnassignedReviewUrgentHearingRequestTask(
        caseId
      );
    });
    ...
    test('As a Fee-Paid Judge, complete the Review Urgent Hearing Request - Judge task', async ({
      ...
      test.slow();
      await urgentHearingSteps.verifyFeePaidJudgeCanCompleteTheUnassignedReviewUrgentHearingRequestTask(
        caseId
      );
    });
...
test.describe.serial(
  'WA - Review Urgent Hearing Request Judge task - Reassign to TCW tests',
  {
    tag: '@work-allocation'
  },
  async () => {
    ...
    test('As a Judge, assign the Review Urgent Hearing Request task to Tribunal Caseworker', async ({
      ...
      test.slow();
      await urgentHearingSteps.verifySalariedJudgeCanReassignTheReviewUrgentHearingRequestTaskToTcw(
        caseId
      );
    });
...
test.describe.serial(
  'WA - Judge completes Review Urgent Hearing Request task manually',
  {
    tag: '@work-allocation'
  },
  async () => {
    ...
    test('As a Judge, complete the Review Urgent Hearing Request task manually', async ({
      ...
      test.slow();
      await urgentHearingSteps.verifySalariedJudgeCanCompleteTheReviewUrgentHearingRequestTaskManually(
        caseId
      );
    });
...
test.describe.serial(
  'WA - Review Urgent Hearing Request Judge task automatic cancellation when case is void',
  {
    tag: '@work-allocation'
  },
  async () => {
    ...
    test('As a Judge, view the Review Urgent Hearing Request - Judge task', async ({
      ...
      test.slow();
      await urgentHearingSteps.verifySalariedJudgeCanViewAndSelfAssignTheReviewUrgentHearingRequestTask(
        caseId
      );
    });
    ...
    test('Review Urgent Hearing Request - Judge task is cancelled automatically when case is void', async ({
      ...
      test.slow();
      await urgentHearingSteps.verifyReviewUrgentHearingRequestTaskIsCancelledAutomaticallyWhenTheCaseIsVoid(
        caseId
      );
    });

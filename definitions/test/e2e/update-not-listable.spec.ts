...
test.describe(
  ...
  async () => {
    ...
    test('Not listable test - Not listable error message test', async ({
      updateNotListableSteps
    }) => {
      test.slow();
    ...
    test('Update Not listable test - Directions fulfilled case ready to list', async ({
      updateNotListableSteps
    }) => {
      test.slow();
    ...
    test('Update Not Listable test - Directions not fulfilled - New Due Date Assigned', async ({
      updateNotListableSteps
    }) => {
      test.slow();
    ...
    test('Update Not listable test - Directions not fulfilled - Case moves to ready to list', async ({
      updateNotListableSteps
    }) => {
      test.slow();
    ...
    test('Update Not listable test - Directions not fulfilled - Case moves to With FTA', async ({
      updateNotListableSteps
    }) => {
      test.slow();
    ...
    test('Update Not listable test - Directions not fulfilled - Interlocutory Review (TCW)', async ({
      updateNotListableSteps
    }) => {
      test.slow();
    ...
    test('Update Not listable test - Directions not fulfilled - Interlocutory Review (Judge)', async ({
      updateNotListableSteps
    }) => {
      test.slow();

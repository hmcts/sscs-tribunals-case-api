...
test.describe.serial(
  'WA - Review Reinstatement Request Judge task initiation and completion tests by Salaried Judge',
  {
    tag: '@work-allocation'
  },
  async () => {
    ...
    test('As a Salaried Judge, view the Review Reinstatement Request - Judge task', async ({
      ...
      test.slow();
      await reinstatementSteps.verifySalariedJudgeCanViewTheUnassignedReviewReinstatementRequestTask(
        caseId
      );
    });
    ...
    test('As a Salaried Judge, complete the Review Reinstatement Request - Judge task', async ({
      ...
      test.slow();
      await reinstatementSteps.verifySalariedJudgeCanCompleteTheUnassignedReviewReinstatementRequestTask(
        caseId
      );
    });
...
test.describe.serial(
  'WA - Review Reinstatement Request Judge task initiation and completion tests by Fee-Paid Judge',
  {
    tag: '@work-allocation'
  },
  async () => {
    ...
    test('As a Fee-Paid Judge, view the Review Reinstatement Request - Judge task', async ({
      ...
      test.slow();
      await reinstatementSteps.verifyFeePaidJudgeCanViewTheUnassignedReviewReinstatementRequestTask(
        caseId
      );
    });
    ...
    test('As a Fee-Paid Judge, complete the Review Reinstatement Request - Judge task', async ({
      ...
      test.slow();
      await reinstatementSteps.verifyFeePaidJudgeCanCompleteTheUnassignedReviewReinstatementRequestTask(
        caseId
      );
    });
...
test.describe.serial(
  'WA - Review Reinstatement Request Judge task - Reassign to TCW tests',
  {
    tag: '@work-allocation'
  },
  async () => {
    ...
    test('As a Judge, assign the Review Reinstatement Request task to Tribunal Caseworker', async ({
      ...
      test.slow();
      await reinstatementSteps.verifySalariedJudgeCanReassignTheReviewReinstatementRequestTaskToTcw(
        caseId
      );
    });
...
test.describe.serial(
  'WA - Judge completes Review Reinstatement Request task manually',
  {
    tag: '@work-allocation'
  },
  async () => {
    ...
    test('As a Judge, complete the Review Reinstatement Request task manually', async ({
      ...
      test.slow();
      await reinstatementSteps.verifySalariedJudgeCanCompleteTheReviewReinstatementRequestTaskManually(
        caseId
      );
    });
...
test.describe.serial(
  'WA - Review Reinstatement Request Judge task automatic cancellation when case is void',
  {
    tag: '@work-allocation'
  },
  async () => {
    ...
    test('As a Judge, view the Review Reinstatement Request - Judge task', async ({
      ...
      test.slow();
      await reinstatementSteps.verifySalariedJudgeCanViewAndSelfAssignTheReviewReinstatementRequestTask(
        caseId
      );
    });
    ...
    test('Review Reinstatement Request - Judge task is cancelled automatically when case is void', async ({
      ...
      test.slow();
      await reinstatementSteps.verifyReviewReinstatementRequestTaskIsCancelledAutomaticallyWhenTheCaseIsVoid(
        caseId
      );
    });

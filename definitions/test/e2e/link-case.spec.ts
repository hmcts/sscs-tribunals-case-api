...
test.describe('Link a case tests', () => {
  // Happy Path test:
  test(
    'As a caseworker link a case to another case',
    { tag: '@nightly-pipeline' },
    async ({ linkACaseSteps }) => {
  ...
  test(
    'As a caseworker I should not be able link a case to a non-existent case',
    { tag: '@nightly-pipeline' },
    async ({ linkACaseSteps }) => {
  ...
  test(
    'As a caseworker I should not be able to link a case to itself',
    { tag: '@nightly-pipeline' },
    async ({ linkACaseSteps }) => {
  ...
  test(
    'As a caseworker I should be able to unlink cases',
    { tag: '@todo - as remove button is not working' },
    async ({ linkACaseSteps }) => {

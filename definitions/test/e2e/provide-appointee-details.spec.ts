...
test.describe(
  ...
  () => {
    ...
    test('As a Caseworker verify Provide Appointee Details is not visible', async ({
      provideAppointeeDetailsSteps
    }) => {
      await provideAppointeeDetailsSteps.performAttemptAppointeeDetailsNonDormantCase(
        caseId
      );
    });
  }
...
test.describe(
  ...
  () => {
    ...
    test('As a Caseworker Provide No Appointee Details on a Dormant Case', async ({
      provideAppointeeDetailsSteps
    }) => {
...
test.describe(
  ...
  () => {
    ...
    test('As a Caseworker Provide Appointee Details on a Dormant Case', async ({
      provideAppointeeDetailsSteps
    }) => {

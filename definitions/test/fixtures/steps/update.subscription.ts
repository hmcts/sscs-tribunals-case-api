...
export class UpdateSubscription extends BaseStep {
  //updated class
  ...
  async performUpdateSubscription(caseId: string) {
    // added new method regarding subscription event
    // Creating case - PIP
    ...
    await this.historyTab.verifyPageContentByKeyValue(
      'Comment',
      'Event Description for Automation Verification'
    );

...
export class ReferredByAdmin extends BaseStep {
  ...
  async verifyTcwWithoutCaseAllocatorRoleCanViewReviewReferredByAdminTask(
    caseId: string
  ) {
  ...
  async verifyTcwWithCaseAllocatorRoleCanViewAndAssignReferredByAdminTask(
    caseId: string
  ) {
  ...
  async verifyTcwAsAnAssignedUserForReferredByAdminTaskCanViewAndCompleteTheTask(
    caseId: string
  ) {
  ...
  async verifyReferredByAdminTaskIsCancelledAutomaticallyWhenTheCaseIsVoid(
    caseId: string
  ) {

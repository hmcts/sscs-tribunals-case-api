...
export abstract class BaseStep {
  ...
  protected constructor(page: Page) {
    ...
    this.eventNameAndDescriptionPage = new EventNameEventDescriptionPage(
      this.page
    );
    ...
    this.provideAppointeeDetailsPage = new ProvideAppointeeDetailsPage(
      this.page
    );
    ...
    this.uploadDocumentFurtherEvidencePage =
      new UploadDocumentFurtherEvidencePage(this.page);
    this.updateLanguagePreferencePage = new UpdateLanguagePreferencePage(
      this.page
    );
    this.amendInterlocReviewStatePage = new AmendInterlocReviewStatePage(
      this.page
    );

...
export class Reinstatement extends BaseStep {
  ...
  async verifySalariedJudgeCanViewTheUnassignedReviewReinstatementRequestTask(
    caseId: string
  ): Promise<void> {
  ...
  async verifySalariedJudgeCanCompleteTheUnassignedReviewReinstatementRequestTask(
    caseId: string
  ): Promise<void> {
  ...
  async verifySalariedJudgeCanReassignTheReviewReinstatementRequestTaskToTcw(
    caseId: string
  ): Promise<void> {
    // Verify Salaried Judge self assigns the task
    await this.loginUserWithCaseId(credentials.salariedJudge, true, caseId);
  ...
  async verifyFeePaidJudgeCanViewTheUnassignedReviewReinstatementRequestTask(
    caseId: string
  ): Promise<void> {
  ...
  async verifyFeePaidJudgeCanCompleteTheUnassignedReviewReinstatementRequestTask(
    caseId: string
  ): Promise<void> {
  ...
  async verifyTcwCanCompleteTheAssignedReviewReinstatementRequestTask(
    caseId: string
  ): Promise<void> {
  ...
  async verifySalariedJudgeCanCompleteTheReviewReinstatementRequestTaskManually(
    caseId: string
  ): Promise<void> {
    // Verify Salaried Judge self assigns the task
    await this.loginUserWithCaseId(credentials.salariedJudge, false, caseId);
  ...
  async verifySalariedJudgeCanViewAndSelfAssignTheReviewReinstatementRequestTask(
    caseId: string
  ): Promise<void> {
    // Verify Review Reinstatement Request - Judge task is displayed to the Salaried Judge
    await this.verifySalariedJudgeCanViewTheUnassignedReviewReinstatementRequestTask(
      caseId
    );
    await this.tasksTab.selfAssignTask(task.name);
    await this.tasksTab.verifyPageContentByKeyValue(
  ...
  async verifyReviewReinstatementRequestTaskIsCancelledAutomaticallyWhenTheCaseIsVoid(
    caseId: string
  ): Promise<void> {

...
export class ReferredByJudge extends BaseStep {
  ...
  async verifyTcwWithoutCaseAllocatorRoleCanViewReviewReferredByJudgeTask(
    caseId: string
  ) {
  ...
  async verifyTcwWithCaseAllocatorRoleCanViewAndAssignReferredByJudgeTask(
    caseId: string
  ) {
  ...
  async verifyTcwAsAnAssignedUserForReferredByJudgeTaskCanViewAndCompleteTheTask(
    caseId: string
  ) {
  ...
  async verifyReferredByJudgeTaskIsCancelledAutomaticallyWhenTheCaseIsVoid(
    caseId: string
  ) {

...
export class UrgentHearing extends BaseStep {
  ...
  async requestAndGrantAnUrgentHearing(caseId: string) {
    ...
    await this.eventNameAndDescriptionPage.verifyPageContent(
      issueDirectionTestdata.eventNameCaptor
    );
    await this.eventNameAndDescriptionPage.confirmSubmission();
  ...
  async verifyInterlocutoryJudgeCanViewTheAssignedReviewUrgentHearingRequestTask(
    caseId: string
  ): Promise<void> {
  ...
  async verifyInterlocutoryJudgeCanCompleteTheAssignedReviewUrgentHearingRequestTask(
    caseId: string
  ): Promise<void> {
  ...
  async verifySalariedJudgeCanViewTheUnassignedReviewUrgentHearingRequestTask(
    caseId: string
  ): Promise<void> {
  ...
  async verifySalariedJudgeCanCompleteTheUnassignedReviewUrgentHearingRequestTask(
    caseId: string
  ): Promise<void> {
    ...
    await this.sendCaseToTcwPage.selectInterlocutoryReviewState(
      sendCaseToTcwData.interlocReviewStateSelectValue
    );
    await this.sendCaseToTcwPage.enterNote(sendCaseToTcwData.enterNoteInput);
    await this.sendCaseToTcwPage.confirmSubmission();

    await this.eventNameAndDescriptionPage.verifyPageContent(
      sendCaseToTcwData.caption
    );
    await this.eventNameAndDescriptionPage.confirmSubmission();
  ...
  async verifySalariedJudgeCanReassignTheReviewUrgentHearingRequestTaskToTcw(
    caseId: string
  ): Promise<void> {
    // Verify Salaried Judge self assigns the task
    await this.loginUserWithCaseId(credentials.salariedJudge, true, caseId);
  ...
  async verifyFeePaidJudgeCanViewTheUnassignedReviewUrgentHearingRequestTask(
    caseId: string
  ): Promise<void> {
  ...
  async verifyFeePaidJudgeCanCompleteTheUnassignedReviewUrgentHearingRequestTask(
    caseId: string
  ): Promise<void> {
  ...
  async verifyTcwCanCompleteTheAssignedReviewUrgentHearingRequestTask(
    caseId: string
  ): Promise<void> {
    ...
    await this.tasksTab.verifyManageOptions(
      task.name,
      task.assignedManageOptionsForTCW
    );
    await this.tasksTab.verifyNextStepsOptions(
      task.name,
      task.nextStepsOptions
    ...
    await this.amendInterlocReviewStatePage.selectReviewState(
      amendInterlocReviewStateData.interlocReviewStateSelectValue
    );
  ...
  async verifySalariedJudgeCanCompleteTheReviewUrgentHearingRequestTaskManually(
    caseId: string
  ): Promise<void> {
    // Verify Salaried Judge self assigns the task
    await this.loginUserWithCaseId(credentials.salariedJudge, false, caseId);
  ...
  async verifySalariedJudgeCanViewAndSelfAssignTheReviewUrgentHearingRequestTask(
    caseId: string
  ): Promise<void> {
    // Verify Review Urgent Hearing Request - Judge task is displayed to the Salaried Judge
    await this.verifySalariedJudgeCanViewTheUnassignedReviewUrgentHearingRequestTask(
      caseId
    );
    await this.tasksTab.selfAssignTask(task.name);
    await this.tasksTab.verifyPageContentByKeyValue(
  ...
  async verifyReviewUrgentHearingRequestTaskIsCancelledAutomaticallyWhenTheCaseIsVoid(
    caseId: string
  ): Promise<void> {

...
SYSTEM_USER_ID=$(curl --silent --show-error -X GET "${IDAM_API_BASE_URL}/o/userinfo" -H "accept: application/json" -H "authorization: Bearer ${SSCS_SYSTEM_USER_TOKEN}" | jq -r .uid)
